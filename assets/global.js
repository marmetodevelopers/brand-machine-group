...
let announcementElement = document.querySelector('.announcement-bar__wrapper');
if (announcementElement) {
  if (window.innerWidth > 750) {
    const announcementEle = document.querySelector("#announcement-bar__wrapper")
    if(announcementEle){
...
//shopy by category
let shopCategoryElement = document.querySelector('.shop-category-main__flex');
if (shopCategoryElement) {
  if (window.innerWidth > 990) {
    let flkty = new Flickity('.shop-category-main__flex', {
      contain: true,
      wrapAround: true,
...
let collectonSlider = document.querySelector('.featured-collection-card__wrapper');
if (collectonSlider) {
  if (window.innerWidth > 990) {
    let flkty = new Flickity('.featured-collection-card__wrapper', {
      contain: true,
      wrapAround: true,
      prevNextButtons: true,
      pageDots: false,
...
const brandCategoryElement = document.querySelectorAll(".brands-container")
brandCategoryElement.forEach(element=>{
...
class BrandStickyHeader extends HTMLElement {
    constructor() {
      super();
    }

    connectedCallback() {
      this.header = document.querySelector('.brand-section-header');
  ...
  customElements.define('brand-sticky-header', BrandStickyHeader);
